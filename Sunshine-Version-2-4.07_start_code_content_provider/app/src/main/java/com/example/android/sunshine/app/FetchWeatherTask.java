...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cursor = resolver.query(WeatherContract.LocationEntry.CONTENT_URI, null, selection, selectionArg, null);
        if (cursor.moveToFirst()) {
            // If it exists, return the current ID
            long _id = cursor.getLong(cursor.getColumnIndex(WeatherContract.LocationEntry._ID));
            return _id;
        } else {
            ...
            Uri u_id = resolver.insert(uri, contentValues);
            long _id = Long.parseLong(u_id.getLastPathSegment());
            return _id;
        }
